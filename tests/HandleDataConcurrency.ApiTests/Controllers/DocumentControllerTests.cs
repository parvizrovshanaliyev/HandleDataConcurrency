...
public class DocumentControllerTests : IClassFixture<CustomWebApplicationFactory<Program>>
{
    ...
    /// <summary>
    /// simultaneously obtaining the document number and testing Concurrency Conflicts handling
    /// </summary>
    [Fact]
    public async Task GivenDocumentEndpoint_WhenGetDocumentNumber_ThenOk()
    {
        using var client1 = _factory
            .CreateClient();

        using var client2 = _factory
            .CreateClient();
